...
I have experience with Python, Java, C++, and basic web development. Preferred issues involve APIs, backend logic, data processing, debugging, performance improvements, or other implementation-focused work in existing production code. Areas for growth include backend development, general software engineering, and ML-related components that do not require advanced ML knowledge. Documentation-only, primarily test-maintenance, and mostly visual/UI tasks are lower priority.
